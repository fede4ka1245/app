          ...
          <Grid container alignItems={'center'} width={'100%'} height={'100%'} p={1} justifyContent={'space-between'}>
            ...
            <Grid zIndex={2} item display={'flex'} alignItems={'center'}>
              <svg width="12" height="12" viewBox="0 0 8 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.25033 6.61331L4.12983 6.50784C1.38845 4.27793 0.650391 3.49445 0.650391 2.21376C0.650391 1.15907 1.50895 0.315319 2.54826 0.315319C3.42189 0.315319 3.91895 0.812527 4.25033 1.1892C4.5817 0.812527 5.07877 0.315319 5.95239 0.315319C7.00677 0.315319 7.85027 1.17413 7.85027 2.21376C7.85027 3.49445 7.1122 4.27793 4.37083 6.50784L4.25033 6.61331Z" fill="white"/>
              </svg>
              <Typography color={'white'} fontFamily={'Gilroy'} fontSize={'12px'} pl={'3px'}>
                112
              </Typography>
            </Grid>
          </Grid>
